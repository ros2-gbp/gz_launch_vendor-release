...
Name:           ros-kilted-gz-launch-vendor
Version:        0.2.2
...
%description
Vendor package for: gz-launch8 8.0.2 Gazebo Launch : Run and manage programs and
plugins
...
%changelog
* Mon Nov 10 2025 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.2.2-1
